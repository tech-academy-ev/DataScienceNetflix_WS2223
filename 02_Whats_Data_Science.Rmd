...
To get started you should install `R` and RStudio locally on your computer. Before we try to put in word how to do so: Here’s a [DataCamp tutorial](https://www.datacamp.com/tutorial/installing-R-windows-mac-ubuntu) on how to do that. If you struggle, we will help you with installing at the “Introduction to Coding” Workshop or at our first Coding Meetup.
...
To receive the certificate, both beginners and advanced learners must complete at least 6 courses of the curriculum (6/7 courses).
After completing the curriculum and the project's requirements, you will receive your TechAcademy certificate!
...
6.  [Writing Efficient R Code (4h)](https://www.datacamp.com/courses/writing-efficient-r-code)
7.  [Reporting with R Markdown (4h)](https://app.datacamp.com/learn/courses/reporting-with-rmarkdown)


**Data Science in R (Advanced) -- Exchange Pool**

-   [Intermediate Data Visualization with ggplot2](https://www.datacamp.com/courses/data-visualization-with-ggplot2-2)
...
## What's Python and Datacamp Courses?
...
### Google Colab, Anaconda and Jupyter
...
*Python  is already installed on Linux and Unix systems (such as macOS), but often it is an older version. Since there are differences in the handling of Python version 2 – which is not longer supported anymore – and version 3, we decided to work with version 3.6 or higher.
...
3.  [Data Manipulation with pandas (4h)](https://app.datacamp.com/learn/courses/data-manipulation-with-pandas)
4.  [Cleaning Data in Python (4h)](https://app.datacamp.com/learn/courses/cleaning-data-in-python)
5.  [Introduction to Data Visualization with Matplotlib (4h)](https://app.datacamp.com/learn/courses/introduction-to-data-visualization-with-matplotlib)
6.  [Exploratory Data Analysis in Python (4h)](https://app.datacamp.com/learn/courses/exploratory-data-analysis-in-python)
7.  [Python for Data Science Toolbox (Part 1) (3h)](https://app.datacamp.com/learn/courses/python-data-science-toolbox-part-1)

**Data Science with Python (Advanced)**

1.  [Intermediate Python (4h)](https://app.datacamp.com/learn/courses/intermediate-python)
2.  [Data Manipulation with pandas (4h)](https://app.datacamp.com/learn/courses/data-manipulation-with-pandas)
3.  [Cleaning Data in Python (4h)](https://app.datacamp.com/learn/courses/cleaning-data-in-python)
...
5.  [Python Data Science Toolbox (Part 2) (4h)](https://app.datacamp.com/learn/courses/python-data-science-toolbox-part-2)
6.  [Feature Engineering for NLP in Python (4h)](https://app.datacamp.com/learn/courses/feature-engineering-for-nlp-in-python)
7.  [Writing Efficient Code with pandas (4h)](https://app.datacamp.com/learn/courses/writing-efficient-code-with-pandas)
...
-   [Introduction to Data Visualization with Plotly in Python 4h)](https://app.datacamp.com/learn/courses/introduction-to-data-visualization-with-plotly-in-python)
-   [Intermediate Regression with Statsmodels in Python (4h)](https://app.datacamp.com/learn/courses/intermediate-regression-with-statsmodels-in-python)
-  [Machine Learning in Scikit-learn 4h)](https://app.datacamp.com/learn/courses/machine-learning-with-scikit-learn)
...
knitr::include_graphics("plot/tabelle.jpg")
```
