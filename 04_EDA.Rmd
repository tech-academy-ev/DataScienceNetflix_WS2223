...
install.packages("magick") # for including a .png in plots
# library(gghighlight)
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.show="hold", fig.align="center", out.width="50%"}
knitr::include_graphics("plot/request.jpg")
```
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.show="hold", fig.align="center", out.width="50%"}
knitr::include_graphics("plot/request_progress.jpg")
```
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.show="hold", fig.align="center", out.width="50%"}
knitr::include_graphics("plot/netflix_count.jpeg")
```
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.show="hold", fig.align="center", out.width="50%"}
knitr::include_graphics("plot/top10.jpg")
```
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.show="hold", fig.align="center", out.width="50%"}
knitr::include_graphics("plot/movieduration.jpg")
```
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.show="hold", fig.align="center", out.width="50%"}
knitr::include_graphics("plot/dynamic.gif")
```
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.show="hold", fig.align="center", out.width="50%"}
knitr::include_graphics("plot/monthly.jpg")
```
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.show="hold", fig.align="center", out.width="50%"}
knitr::include_graphics("plot/netflix_average_duration.jpeg.png")
```
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.show="hold", fig.align="center", out.width="75%"}
knitr::include_graphics("plot/Binge.jpg")
```
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.show="hold", fig.align="center", out.width="75%"}
knitr::include_graphics("plot/Scatter with density.jpg")
```

::: {.tips .r data-latex="r"}
To achieve this visualization calls from the packages ggExtra can be added to your ggplot. Have a look [at](https://r-graph-gallery.com/277-marginal-histogram-for-ggplot2.html) [these](https://r-charts.com/correlation/scatter-plot-marginal-histograms-ggplot2/) [sources](http://domenicovistocco.it/en/dv-blog/ggside/) and find your code. The shown visulaization was plotted with Python, R’s output can therefore vary !
:::
...
knitr::include_graphics("plot/netflix_wordcloud.jpeg")
```
