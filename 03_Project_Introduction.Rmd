...
This semester, we will have a look at Netflix data! More precisely, we are first analyzing a very detailed general Netflix data set, compiled on [kaggle](https://www.kaggle.com/datasets/kyleahmurphy/nass-honey-bee-20152021?select=NASS_Bee-Stressors_2015-2021.csv), after which you will get the chance to look at your own Netflix data. You will find all kinds of information in the data sets - valuable and useless ones.
